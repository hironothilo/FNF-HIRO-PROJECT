...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		titleText = new FlxSprite(titleJSON.startx + 40, titleJSON.starty);
	...
	override function update(elapsed:Float)
	{
		...
		if(titleText != null){
			var mult:Float = FlxMath.lerp(1, titleText.scale.y, CoolUtil.boundTo(1 - (elapsed * 9), 0, 1));
	...
	function skipIntro():Void
	{
		...
		{
			logoBl.y += 400;
			FlxTween.tween(logoBl, {y: logoBl.y - 400}, 0.5, {ease: FlxEase.smootherStepInOut});
